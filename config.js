    ...
    Profiles: [
        {
            ...
            Profile: {
                Backup: true,
                PreModCommand: "taskkill /IM EmbyServer.exe /F",
                DashboardBasePath: "C:\\Users\\Luke\\AppData\\Roaming\\Emby-Server\\system\\dashboard-ui",
                FindAndOverwrite: [
                    { source: "videos.js", dest: "assets\\www\\videos" },
                    { source: "music.js", dest: "music" },
                    { source: "tv.js", dest: "tv" },
                    { source: "qualityoptions.js", dest: "assets\\www\\modules\\common" },
        ...
        },
        {
            ...
            Profile: {
                Backup: false,
                PreModCommand: "apktool d C:\\Users\\Luke\\Desktop\\EmbyAndroidLab\\emby-android-google-armeabi-v7a-release.apk -o C:\\Users\\Luke\\Desktop\\EmbyAndroidLab\\MediaBrowser.Mobile -f",
                ...
                FindAndReplace: [
                    ...
                    {
                        destFile: "assets\\www\\modules\\listview\\listview.js",
                        findString: "options.showDateModified&&textlines.push(datetime.toLocaleString(datetime.parseISO8601Date(item.DateModified,!0)))",
                        replaceString: "options.showDateModified&&textlines.push(`${datetime.toLocaleString(datetime.parseISO8601Date(item.DateModified, !0))}, ${Math.round(item.Size / 1024)} KB`)"
                    }
                ]
